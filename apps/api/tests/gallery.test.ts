...
describe("Gallery Flow - Comprehensive", () => {
    ...
    describe("2. List Galleries", () => {
        ...
        it("should support pagination", async () => {
            const res = await app.handle(
                new Request("http://localhost/api/gallery?page=1&limit=2")
            );
        ...
        it("should handle page out of range", async () => {
            const res = await app.handle(
                new Request("http://localhost/api/gallery?page=999")
            );
        ...
        it("should support search by title", async () => {
            const res = await app.handle(
                new Request("http://localhost/api/gallery?search=Public")
            );
