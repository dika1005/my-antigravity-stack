...
const tags = [
    "sunset", "sunrise", "mountain", "ocean", "forest", "city", "street",
    "portrait", "landscape", "macro", "night", "black-and-white", "colorful",
    "minimal", "vintage", "modern", "dramatic", "peaceful", "vibrant", "moody"
];
...
async function main() {
    ...
    for (const galleryData of sampleGalleries) {
        ...
        const randomUserEmail = userEmails[Math.floor(Math.random() * (userEmails.length - 1)) + 1] as string;
