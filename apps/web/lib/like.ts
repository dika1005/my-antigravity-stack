...
export const likeApi = {
  ...
  async toggleLike(
    ...
    if (target === 'gallery') {
      return isCurrentlyLiked ? this.unlikeGallery(targetId) : this.likeGallery(targetId)
    } else {
      return isCurrentlyLiked ? this.unlikeImage(targetId) : this.likeImage(targetId)
    }
  },
}
