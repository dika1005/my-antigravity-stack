...
// Mock recent uploads
const recentUploads = [
    { id: 1, src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=80', likes: 23, comments: 5 },
    { id: 2, src: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=400&q=80', likes: 18, comments: 3 },
    { id: 3, src: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80', likes: 31, comments: 8 },
    { id: 4, src: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=400&q=80', likes: 12, comments: 2 },
    { id: 5, src: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=400&q=80', likes: 27, comments: 6 },
    { id: 6, src: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&q=80', likes: 45, comments: 18 },
]
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
                            <button
                                ...
                                className={`px-6 py-3 rounded-full text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap ${activeTab === 'uploads'
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-full text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap ${activeTab === 'liked'
                                    ? 'bg-gradient-to-r from-violet-500 to-indigo-600 text-white shadow-lg shadow-violet-500/25'
                                    : 'bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-full text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap ${activeTab === 'saved'
                                    ? 'bg-gradient-to-r from-violet-500 to-indigo-600 text-white shadow-lg shadow-violet-500/25'
                                    : 'bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10'
                                    }`}
                            >
                        ...
                        {activeTab === 'liked' && (
                            <div className="text-center py-16">
                                ...
                                <h3 className="text-xl font-semibold text-white mb-2">Belum ada foto yang disukai</h3>
