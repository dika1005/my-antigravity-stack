...
import { UploadModal, GalleryGrid, GalleryHeader, LightboxModal } from '@/components/gallery'
  ...
  return (
    <main className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div
          className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-fuchsia-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"
