...
export function CinemaMode({ imageId, onClose, onImageSelect }: CinemaModeProps) {
    ...
    return (
        <div
            ...
            className={`fixed inset-0 z-[100] flex flex-col transition-all duration-300 ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'
                }`}
        >
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="flex-1 flex items-center justify-center p-4 md:p-8 min-h-0">
                            <div
                                className={`relative max-w-full max-h-full transition-all duration-500 ${isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
                                    }`}
                                style={{
                            ...
                            >
                                ...
                                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                                    <Image
                                        ...
                                        className={`object-contain max-h-[calc(100vh-280px)] w-auto transition-opacity duration-500 ${imageLoaded ? 'opacity-100' : 'opacity-0'
                                            }`}
                        ...
                        {/* Info Panel - Floating */}
                        <div className={`absolute top-4 left-4 max-w-sm transition-all duration-500 delay-200 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'
                            }`}>
